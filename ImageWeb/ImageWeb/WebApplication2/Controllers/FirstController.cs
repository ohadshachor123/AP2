...
namespace WebApplication2.Controllers
{
    public class FirstController : Controller
    {
        ...
        {
            ViewBag.status = "Enter the status here";
            ViewBag.imageCount = "Image Count here";
            return View();
        }
        ...
        {
            JObject data = new JObject();
            data["firstName"] = "Insert first name here";
            data["lastName"] = "Insert last name here";
            data["idNum"] = "Insert the id number here";
            return data;
        }
